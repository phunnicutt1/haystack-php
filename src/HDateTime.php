...
class HDateTime extends HVal
{
    ...
    public function equals(HDateTime $that): bool
    {
    ...
    public function compareTo(HDateTime $that): int
    {
    ...
    {
        if ($args[2] instanceof HTimeZone) {
            return self::makeFromComponents($args[0], $args[1], $args[2], $args[3]);
        } elseif ($args[1] instanceof HTimeZone) {
